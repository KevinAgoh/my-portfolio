export const projects = [
  {
    title: "felmo shop",
    subtitle: "Statamic & React CMS",
    description:
      "This is the main project I worked on for more than a year. Revamped most of the frontend (homepage, category pages, menu/searchbar, product pages, newsletter form, landing pages, etc...).",
    image: "./felmoShop.png",
    link: " https://felmo.de/shop",
  },
  {
    title: "Netflix clone",
    subtitle: "React",
...
export const skills = [
  ...
  "Jest",
  "Vue.js",
  "SCSS / Styled components / Tailwind",
];
